...
MEMORY_FRACTION = 0.5
EXISTING_MODEL = 'full_CNN_model3.h5' # False if no model
...
def main():
    ...
    X_train, X_val, y_train, y_val = train_test_split(train_images, labels, test_size=10)
